...
last.setGradient(white);
last.setWeight(0.25);
new bannerSplash("geometry_01.png","/art/3d","Check out my awesome geometry...",white);
new bannerSplash("geometry_02.png","/art/3d","Check out my awesome geometry...",white);
new bannerSplash("geometry_03.png","/art/3d","Check out my awesome geometry...",white);
