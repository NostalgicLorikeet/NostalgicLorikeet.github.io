new sbSection("Overview","overview.png","true","true");
	...
	new sbLink("Wiki","https://wiki.hitscan.org","Wiki, basically empty rn","false","true");
	...
	new sbLink("Stats","/stats","Website and some other stats","true","true");
...
new sbSection("Archives & other files","archives.png","true","true");
	new sbLink("Archives and mirrors","/archives_mirrors","A list of some things that I have archived on the file server","true","true");
...
new sbSection("Art","art.png","true","true");
	new sbLink("Art","/art","The main art page","false","true");
...
new sbSection("GMod stuff","gmod.png","true","true");
	new sbLink("Maps","","gmod_maps","true","false");
	new sbLink("gm_visage","A map I made in January of 2022","/gmod_maps/gm_visage","true","true");
		new sbELink("Steam Workshop","https://steamcommunity.com/sharedfiles/filedetails/?id=2731567400","On Steam Workshop","true","true");
	new sbLink("gm_conetown","WIP map started in July 2023","/gmod_maps/gm_conetown","false","true");
	new sbLink("gm_mazebox","WIP map started in December 2023","/gmod_maps/gm_mazebox","false","true");
	new sbLink("Maps","More GMod maps, including old, bad, and unreleased ones","/gmod_maps","false","true");
